...
- `references/quant-scenarios.md` + тулкит `quant/` (numpy/scipy, свой `.venv-quant`) —
  ...
  **Стресс-входы** (шок-вектор: уровень/наклон кривой, FX, кредит-спред, просадка эквити,
  хейркат недвижимости + p-диапазоны) могут приходить из `../macro-geopolitics/` — тогда MC
  прогоняется **под сценарии** (см. `../macro-geopolitics/references/scenario-asset-map.md`).
